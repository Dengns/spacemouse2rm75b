"""SpaceMouse teleoperation config for RM75B — admittance(导纳/UDP/力控) + gripper 合并版.

合并自:
  - config_admittance.py  (UDP 实时反馈 / 力位混合 / 导纳相关参数, 全部保留)
  - config_switch.py (LJL)  (夹爪配置: disabled / incremental / binary / Switching 四模式 + 退出开关)

UDP 高频六维力反馈与导纳参数不动；夹爪段改为 LJL 版四模式 + GRIPPER_OPEN_ON_EXIT。
"""
